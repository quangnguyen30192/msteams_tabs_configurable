...
import { Provider, Input, DropdownProps, Dropdown, Flex, Text, Button, Header } from "@fluentui/react-northstar";
...
export const BotconfigtabTabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: microsoftTeams.settings.SaveEvent) => {
        ...
        microsoftTeams.settings.setSettings({
            contentUrl: host + "/botconfigtabTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            websiteUrl: host + "/botconfigtabTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
